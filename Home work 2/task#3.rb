...
favorite_countries = gets.chomp.split(',').sort
most_hated_countries = gets.chomp.split(',').sort
list = favorite_countries + most_hated_countries
puts list.map { |element| element.squeeze.strip }.join(', ')
